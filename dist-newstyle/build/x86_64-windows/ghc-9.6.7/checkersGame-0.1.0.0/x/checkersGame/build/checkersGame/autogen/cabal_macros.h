...
/* package checkersGame-0.1.0.0 */
#ifndef VERSION_checkersGame
#define VERSION_checkersGame "0.1.0.0"
#endif /* VERSION_checkersGame */
#ifndef MIN_VERSION_checkersGame
#define MIN_VERSION_checkersGame(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_checkersGame */
...
#define CURRENT_COMPONENT_ID "checkersGame-0.1.0.0-inplace-checkersGame"
